...
import sys
sys.path.append('/root/BE/STAligner/STAligner/')
import STAligner
...
mclust_R_local(adata_concat, num_cluster=5, used_obsm='STAligner')
...
adata_concat.write("/root/ST0507/new_model/STAligner/results/staligner_her2_A.h5ad")

with open("/root/ST0507/new_model/STAligner/results/staligner_benchmark_her2_A.json", "w") as f:
