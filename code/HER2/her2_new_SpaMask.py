...
save_path = Path('/root/ST0507/new_model/SpaMask-main/Results')
...
for proj_name in tqdm(proj_list):
    ...
    # 1. Directly load integrated H5AD file (replaces original read_visium)
    ...
    # ==========================================
    # 3. Convert labels to category type and print matching statistics
    # ==========================================
    ...
    # Filter out NA background spots to ensure clean point cloud for ICP
...
adata.obsm['feat'] = PCA(n_components=200, random_state=42).fit_transform(adata.X)
