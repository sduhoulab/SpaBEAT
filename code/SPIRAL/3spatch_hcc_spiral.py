...
input_dir="/data_hou/ST_data_new/model-zn/spiral/data/spatch_hcc/"
results_dir="/data_hou/ST_data_new/model-zn/spiral/results/"
datasets=np.array(['hd', 'xe'])
SEP=','
net_cate='_KNN_'
knn=12
...
with open(os.path.join(results_dir, "spatch_hcc_spiral_benchmark1.json"), "w") as f:
...
ann.write(os.path.join(results_dir, "spatch_hcc_spiral_adata1.h5ad"))
