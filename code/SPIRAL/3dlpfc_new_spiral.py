...
input_dir="../data/DLPFC/processed/Donor1/"
results_dir="../results/"
datasets=np.array([151507,151508,151509,151510])
SEP=','
net_cate='_KNN_'
rad=150
knn=6
...
ann.write('../results/spiral_Sample3_DLPFC.h5ad')
...
with open(os.path.join(results_dir, "spiral_benchmark3.json"), "w") as f:
