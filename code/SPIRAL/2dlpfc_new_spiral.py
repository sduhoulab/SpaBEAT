...
input_dir="../data/DLPFC/processed/Donor2/"
results_dir="../results/"
datasets=np.array([151669,151670,151671,151672])
SEP=','
net_cate='_KNN_'
rad=150
knn=6
...
ann.write('../results/spiral_Sample2_DLPFC.h5ad')
...
with open(os.path.join(results_dir, "spiral_benchmark2.json"), "w") as f:
