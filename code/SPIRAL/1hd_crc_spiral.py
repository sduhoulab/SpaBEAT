...
input_dir="/data_hou/ST_data_new/model-zn/spiral/data/hd_crc/"
results_dir="/data_hou/ST_data_new/model-zn/spiral/results/"
datasets=np.array(['P1CRC', 'P2CRC', 'P5CRC'])
SEP=','
net_cate='_KNN_'
knn=12
...
with open(os.path.join(results_dir, "hd_crc_spiral_benchmark1.json"), "w") as f:
...
ann.write(os.path.join(results_dir, "hd_crc_spiral_adata1.h5ad"))
