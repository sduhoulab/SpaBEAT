...
results_dir="../results/"
datasets=np.array([151673,151674,151675,151676])
SEP=','
net_cate='_KNN_'
rad=150
knn=6
...
with open(os.path.join(results_dir, "spiral_benchmark1.json"), "w") as f:
...
ann.write('../results/spiral_Sample1_DLPFC.h5ad')
