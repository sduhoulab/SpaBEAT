...
input_dir="/data_hou/ST_data_new/model-zn/spiral/data/spatch_ov/"
...
with open(os.path.join(results_dir, "spatch_ov_spiral_benchmark1.json"), "w") as f:
...
ann.write(os.path.join(results_dir, "spatch_ov_spiral_adata1.h5ad"))
