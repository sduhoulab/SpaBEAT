...
datasets = ['20180417_BZ5_control', '20180419_BZ9_control', '20180424_BZ14_control']
...
#]
dataset_names = ['20180417_BZ5_control', '20180419_BZ9_control', '20180424_BZ14_control']
...
correct3 = sc.read_h5ad("/root/ST0507/new_model/spatialign/results/res/correct_data2.h5ad")
...
batch_mapping = {
    '0': '20180417_BZ5_control',
    '1': '20180419_BZ9_control',
    '2': '20180424_BZ14_control'
}
...
merge_data.write("/root/ST0507/new_model/spatialign/results/multiple_adata_PFC.h5ad")

with open("/root/ST0507/new_model/spatialign/results/spatialign_benchmark_PFC.json", "w") as f:
