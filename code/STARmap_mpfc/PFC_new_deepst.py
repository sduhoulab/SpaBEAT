...
data_path = "/root/ST0507/data/starmap_PFC/STARMAP_converted/" 
data_name_list = ['20180417_BZ5_control', '20180419_BZ9_control', '20180424_BZ14_control']

save_path = "/root/ST0507/new_model/DeepST/results" 
...
multiple_adata.write(os.path.join(save_path, "multiple_adata_PFC.h5ad"))

with open(os.path.join(save_path, "deepst_benchmark_PFC.json"), "w") as f:
    json.dump(benchmark_results, f, indent=2)
    
print("\nPFC dataset DeepST integration finished! Results saved.")
