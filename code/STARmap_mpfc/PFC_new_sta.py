...
mclust_R_local(adata_concat, num_cluster=4, used_obsm='STAligner')
...
adata_concat.write("/root/ST0507/new_model/STAligner/results/staligner_PFC.h5ad")

with open("/root/ST0507/new_model/STAligner/results/staligner_benchmark_PFC.json", "w") as f:
