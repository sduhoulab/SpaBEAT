...
# =============== Data Setup ===============
file_fold <- "/root/ST0507/data/starmap_PFC/STARMAP_converted/" 
datasets <- c('20180417_BZ5_control', '20180419_BZ9_control', '20180424_BZ14_control')
...
saveRDS(PRECASTObj, file =  paste0(out_dir, "PFC_PRECASTObj.rds"))
...
print(seuInt)
saveRDS(seuInt, file =  paste0(out_dir, "PFC_seuInt.rds"))
...
write_json(benchmark_results, paste0(out_dir, "PFC_precast_benchmark.json"), pretty = TRUE, auto_unbox = TRUE)
...
PRECASTObj <- readRDS(paste0(out_dir, "PFC_PRECASTObj.rds"))
seuInt <- readRDS(paste0(out_dir, "PFC_seuInt.rds"))
raw_data_root <- "/root/ST0507/data/starmap_PFC/STARMAP_converted/" 
sample_ids <- c('20180417_BZ5_control', '20180419_BZ9_control', '20180424_BZ14_control') 
raw_obj_list <- list()
...
zellkonverter::writeH5AD(sce_int, paste0(out_dir, "PFC_seuInt_with_all_spatial.h5ad"))
...
file_path = '/root/ST0507/new_model/PRECAST/results/PFC_seuInt_with_all_spatial.h5ad'
