import sys
sys.path.insert(0, '/root/BE/SPIRAL')
...
input_dir="/root/ST0507/data/starmap_PFC/STARMAP_converted/"
results_dir="/root/ST0507/new_model/Spiral/results/"
datasets=np.array(['20180417_BZ5_control', '20180419_BZ9_control', '20180424_BZ14_control'])
SEP=','
net_cate='_KNN_'
rad=150
knn=8
...
with open(os.path.join(results_dir, "spiral_benchmark_merfish1.json"), "w") as f:
...
ann.write('/root/ST0507/new_model/Spiral/results/spiral_PFC.h5ad')
