...
save_path = "/data/ZhaoMH/ST0507/GraphST-main/results"
...
for dataset in datasets:  
    ...
    adata = sc.read_h5ad(os.path.join(file_fold, dataset, f"slice_{batch_name}.h5ad"))
...
adata.write(os.path.join(save_path, "multiple_adata_starmap.h5ad"))

with open(os.path.join(save_path, "multiple_adata_starmap.json"), "w") as f:
    json.dump(benchmark_results, f, indent=2)

print("\n🎉 MERFISH GraphST integration complete.")