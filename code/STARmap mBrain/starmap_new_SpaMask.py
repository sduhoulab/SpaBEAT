import sys
sys.path.append("/data/ZhaoMH/ST0507/SpaMask-main")
...
save_path = Path('/data/ZhaoMH/ST0507/SpaMask-main/Results')
...
adata.obsm['feat'] = PCA(n_components=20, random_state=42).fit_transform(adata.X)
