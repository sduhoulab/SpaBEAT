import sys
sys.path.append("/data/ZhaoMH/ST0507/SpaBatch-main")
...
save_path = Path('/data/ZhaoMH/ST0507/SpaBatch-main/Results')
...
for i, proj_name in enumerate(tqdm(proj_list)):
    ...
    file_path = data_root / proj_name / f"slice_{batch_name}.h5ad"
...
sc.pp.scale(adata)
adata.obsm['X_pca'] = PCA(n_components=20, random_state=42).fit_transform(adata.X)
