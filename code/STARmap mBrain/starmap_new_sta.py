...
import sys
sys.path.append('/data/ZhaoMH/ST0507/STAligner-main')
import STAligner
...
for dataset in datasets:   
    ...
    adata = sc.read_h5ad(os.path.join(file_fold, dataset, f"slice_{temp_batch}.h5ad"))
...
mclust_R_local(adata_concat, num_cluster=8, used_obsm='STAligner')
...
adata_concat.write("/data/ZhaoMH/ST0507/STAligner-main/results/staligner_starmap.h5ad")

with open("/data/ZhaoMH/ST0507/STAligner-main/results/staligner_benchmark_starmap.json", "w") as f:
