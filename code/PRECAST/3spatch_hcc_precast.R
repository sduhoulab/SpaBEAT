...
data_paths <- list(
    hd = "/data_hou/ST_data_new/Spatch/transcriptome_hcc_hd_ff/adata.h5ad",
    xe = "/data_hou/ST_data_new/Spatch/transcriptome_hcc_xenium/adata.h5ad"
)
project_name <- "spatch_hcc"
datasets <- c("hd", "xe")
n_domains <- 17
...
PRECASTObj <- AddAdjList(PRECASTObj, platform = "spatch_hcc") 
...
final_h5ad_path <- paste0(out_dir, "spatch_hcc_seuInt_with_all_spatial.h5ad")
