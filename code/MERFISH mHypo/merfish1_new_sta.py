...
adata_concat.write("/data/ZhaoMH/ST0507/STAligner-main/results/staligner_merfish1.h5ad")

with open("/data/ZhaoMH/ST0507/STAligner-main/results/staligner_benchmark_merfish1.json", "w") as f:
