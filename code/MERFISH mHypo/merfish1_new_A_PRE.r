...
datasets <- c('Slice_7', 'Slice_8', 'Slice_9', 'Slice_10', 'Slice_11')
...
saveRDS(PRECASTObj, file =  paste0(out_dir, "merfish1_PRECASTObj.rds"))
...
print(seuInt)
saveRDS(seuInt, file =  paste0(out_dir, "merfish1_seuInt.rds"))
...
write_json(benchmark_results, paste0(out_dir, "merfish1_precast_benchmark.json"), pretty = TRUE, auto_unbox = TRUE)
...
PRECASTObj <- readRDS(paste0(out_dir, "merfish1_PRECASTObj.rds"))
seuInt <- readRDS(paste0(out_dir, "merfish1_seuInt.rds"))
raw_data_root <- "/data/ZhaoMH/ST0507/RAW_SLICE/merfish_mouse1/data/MERFISH_converted/" 
sample_ids <- c('Slice_7', 'Slice_8', 'Slice_9', 'Slice_10', 'Slice_11') 
raw_obj_list <- list()
...
zellkonverter::writeH5AD(sce_int, paste0(out_dir, "merfish1_seuInt_with_all_spatial.h5ad"))
...
file_path = '/data/ZhaoMH/ST0507/PRECAST-main/results/merfish1_seuInt_with_all_spatial.h5ad'
