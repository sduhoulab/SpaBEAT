...
multiple_adata.write("/data_hou/ST_data_new/model-zn/deepst/results/spatch_ov_deepst_adata1.h5ad")

with open("/data_hou/ST_data_new/model-zn/deepst/results/spatch_ov_deepst_benchmark1.json", "w") as f:
