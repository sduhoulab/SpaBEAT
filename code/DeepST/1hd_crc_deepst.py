...
data_name_list = ['P1CRC', 'P2CRC', 'P5CRC']
...
for dataname in data_name_list:
    ...
    adata_path = os.path.join(file_fold, dataname, file_bin)
    ...
    df_meta = pd.read_parquet(df_meta_path + dataname + '_Metadata.parquet')
...
multiple_adata.write("/data_hou/ST_data_new/model-zn/deepst/results/hd_crc_deepst_adata1.h5ad")

with open("/data_hou/ST_data_new/model-zn/deepst/results/hd_crc_deepst_benchmark1.json", "w") as f:
