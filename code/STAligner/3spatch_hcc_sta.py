...
adata_concat.write("/data_hou/ST_data_new/model-zn/STAligner/results/spatch_hcc_sta_adata1.h5ad")

with open("/data_hou/ST_data_new/model-zn/STAligner/results/spatch_hcc_sta_benchmark1.json", "w") as f:
