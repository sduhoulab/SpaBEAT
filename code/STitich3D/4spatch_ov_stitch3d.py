...
adata_ref_path = "/data_hou/ST_data_new/Spatch/scrna/OV/adata.h5ad"
...
save_path = "/data_hou/ST_data_new/model-zn/STitch3D/results/spatch_ov/"
...
adata.write(os.path.join(save_path, "spatch_ov_stitch3d_adata1.h5ad"))

with open(os.path.join(save_path, "spatch_ov_stitch3d_benchmark1.json"), "w") as f:
