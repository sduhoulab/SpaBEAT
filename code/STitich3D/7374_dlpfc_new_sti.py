...
for dataset in datasets:
    adata = sc.read_visium(
        ...
        count_file=str(dataset) + "_filtered_feature_bc_matrix.h5",
        load_images=True,
    )
...
adata, adata_basis = STitch3D.utils.preprocess(
    adata_stitched,
    adata_ref,
    celltype_ref=celltype_list_use,
    sample_col="group",
    slice_dist_micron=[10.0],
    n_hvg_group=500,
)
...
benchmark_results = {
    ...
    "random_seed": 1234,
    "n_hvg_group": 500,
    "slice_dist_micron": [10.0, 300.0, 10.0],
...
adata.write("../results_dlpfc_7374/DLPFC_adata7374.h5ad")

with open("../results_dlpfc_7374/stitch3d_benchmark_7374.json", "w") as f:
