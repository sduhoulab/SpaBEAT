...
np.random.seed(1234)
gm = GaussianMixture(n_components=5, covariance_type='tied', init_params='kmeans')
...
adata.write("../results_dlpfc2/DLPFC_adata2.h5ad")

with open("../results_dlpfc2/stitch3d_benchmark2.json", "w") as f:
