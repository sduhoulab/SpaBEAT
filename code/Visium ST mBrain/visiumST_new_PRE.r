...
saveRDS(PRECASTObj, file =  paste0(out_dir, "visiumST_PRECASTObj.rds"))
...
print(seuInt)
saveRDS(seuInt, file =  paste0(out_dir, "visiumST_seuInt.rds"))
...
write_json(benchmark_results, paste0(out_dir, "visiumST_precast_benchmark.json"), pretty = TRUE, auto_unbox = TRUE)
...
PRECASTObj <- readRDS(paste0(out_dir, "visiumST_PRECASTObj.rds"))
seuInt <- readRDS(paste0(out_dir, "visiumST_seuInt.rds"))
raw_data_root <- "/root/ST0507/data/visumST/Visium_converted/" 
sample_ids <- c('slice_39', 'slice_44') 
raw_obj_list <- list()
...
zellkonverter::writeH5AD(sce_int, paste0(out_dir, "visiumST_seuInt_with_all_spatial.h5ad"))
...
file_path = '/root/ST0507/new_model/PRECAST/results/visiumST_seuInt_with_all_spatial.h5ad'
...
if 'celltype' in adata.obs.columns:
    ...
    if 'ground_truth' in adata.obs.columns:
        print("✅ ground_truth detected, generating celltype...")
        ...
        print("❌ Neither celltype nor ground_truth found. Cannot proceed!")
