...
data_path = "/root/ST0507/data/visumST/Visium_converted/" 
data_name_list = ['slice_39', 'slice_44']
...
multiple_adata.write(os.path.join(save_path, "multiple_adata_visiumST.h5ad"))

with open(os.path.join(save_path, "deepst_benchmark_visiumST.json"), "w") as f:
