...
input_dir="/root/ST0507/data/visumST/Visium_converted/"
results_dir="/root/ST0507/new_model/Spiral/results/"
datasets=np.array(['slice_39', 'slice_44'])
SEP=','
net_cate='_KNN_'
rad=150
knn=8
...
with open(os.path.join(results_dir, "spiral_benchmark_visiumST.json"), "w") as f:
...
ann.write('/root/ST0507/new_model/Spiral/results/spiral_visiumST.h5ad')
