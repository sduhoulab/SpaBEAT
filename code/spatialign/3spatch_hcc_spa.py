...
import numpy as np
datasets = ['hd', 'xe']
save_path = "/data_hou/ST_data_new/model-zn/spatialign/results/spatch_hcc/" 
...
for name, adata in name_to_adata.items():
    ...
    print(f"DEBUG: {type(adata.X)}")
    print(f"DEBUG: NaN: {np.isnan(adata.X.data).any()}")
    print(f"DEBUG: Inf: {np.isinf(adata.X.data).any()}")
    print(f"DEBUG: : {adata.X.shape}")
...
data_list = [
    '/data_hou/ST_data_new/model-zn/spatialign/results/spatch_hcc/hd.h5ad',
    '/data_hou/ST_data_new/model-zn/spatialign/results/spatch_hcc/xe.h5ad'
]
dataset_names = ['hd', 'xe']
...
correct1 = sc.read_h5ad("/data_hou/ST_data_new/model-zn/spatialign/results/spatch_hcc/res/correct_data0.h5ad")
correct2 = sc.read_h5ad("/data_hou/ST_data_new/model-zn/spatialign/results/spatch_hcc/res/correct_data1.h5ad")
...
merge_data.write("/data_hou/ST_data_new/model-zn/spatialign/results/spatch_hcc/spatch_hcc_spa_multiple_adata1.h5ad")

with open("/data_hou/ST_data_new/model-zn/spatialign/results/spatch_hcc/spatch_hcc_spa_benchmark1.json", "w") as f:
