...
save_path = "/data_hou/ZhaoMH/new_model/GraphST/results"
...
adata.write(os.path.join(save_path, "multiple_adata_embryo.h5ad"))

with open(os.path.join(save_path, "multiple_adata_embyro.json"), "w") as f:
    json.dump(benchmark_results, f, indent=2)

print("\n🎉 GraphST integration complete.")