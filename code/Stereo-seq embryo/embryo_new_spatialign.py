...
file_fold = "/data_hou/ZhaoMH/data/stereo_embryo/Embryo_converted/" 
datasets = ['Slice_5', 'Slice_6', 'Slice_7', 'Slice_8', 'Slice_9']
save_path = "/data_hou/ZhaoMH/new_model/spatialign/results" 
data_list = []
Batch_list = []
...
import sys
sys.path.append('/data_hou/BE/Spatialign/spatialign')
import os
import scanpy as sc
...
#]
dataset_names = ['Slice_5', 'Slice_6', 'Slice_7', 'Slice_8', 'Slice_9']
...
correct1 = sc.read_h5ad("/data_hou/ZhaoMH/new_model/spatialign/results/res/correct_data0.h5ad")
correct2 = sc.read_h5ad("/data_hou/ZhaoMH/new_model/spatialign/results/res/correct_data1.h5ad")
correct3 = sc.read_h5ad("/data_hou/ZhaoMH/new_model/spatialign/results/res/correct_data2.h5ad")
correct4 = sc.read_h5ad("/data_hou/ZhaoMH/new_model/spatialign/results/res/correct_data3.h5ad")
correct5 = sc.read_h5ad("/data_hou/ZhaoMH/new_model/spatialign/results/res/correct_data4.h5ad")
...
merge_data.write("/data_hou/ZhaoMH/new_model/spatialign/results/multiple_adata_embryo.h5ad")

with open("/data_hou/ZhaoMH/new_model/spatialign/results/spatialign_benchmark_embryo.json", "w") as f:
