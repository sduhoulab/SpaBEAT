...
for dataset in datasets:   
    ...
    print(f"下采样前细胞数: {adata.n_obs}")
    sc.pp.subsample(adata, fraction=0.5) 
    print(f"下采样后细胞数: {adata.n_obs}")
...
n_domains = 25
mclust_R_local(adata_concat, num_cluster=n_domains, used_obsm='STAligner')
...
adata_concat.write("/data_hou/ZhaoMH/new_model/STAligner/results/staligner_embryo.h5ad")

with open("/data_hou/ZhaoMH/new_model/STAligner/results/staligner_benchmark_embryo.json", "w") as f:
