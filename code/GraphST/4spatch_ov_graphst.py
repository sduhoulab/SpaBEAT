...
#hd_celltypes.sort()
#print(f"Total {len(hd_celltypes)} celltypes:") unknown
#print(hd_celltypes)
...
#xe_celltypes.sort()
#print(f"Total {len(xe_celltypes)} celltypes:")
#print(xe_celltypes)
...
adata.write("/data_hou/ST_data_new/model-zn/graphst/results1/spatch_ov_graphst_adata1.h5ad")

with open("/data_hou/ST_data_new/model-zn/graphst/results1/spatch_ov_graphst_benchmark1.json", "w") as f:
