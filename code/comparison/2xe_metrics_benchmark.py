...
DATA_PATHS = {
    "RAW": "/data_hou/ST_data_new/model-zn/data_raw/xe_breast_raw_adata1.h5ad",
    "DeepST": "/data_hou/ST_data_new/model-zn/deepst/results/xe_breast_rep1-rep2_deepst_adata1.h5ad",
    "GraphST": "/data_hou/ST_data_new/model-zn/graphst/results1/xe_breast_rep1-rep2_graphst_adata1.h5ad",
    "STAligner": "/data_hou/ST_data_new/model-zn/STAligner/results/xe_breast_sta_adata1.h5ad",
    "SPIRAL": "/data_hou/ZhaoMH/new_model/Spiral/results/xe_breast_spiral_adata1.h5ad",
    "STitch3D": "/data_hou/ST_data_new/model-zn/STitch3D/results/xe_breast/xe_breast_rep1-rep2_stitch3d_adata1.h5ad",
    "Spatialign": "/data_hou/ST_data_new/model-zn/spatialign/results/xe_breast/xe_breast_Rep1-2_spa_multiple_adata1.h5ad",
    "PRECAST": "/data_hou/ST_data_new/model-zn/precast/results/xe_breast_seuInt_with_all_spatial.h5ad",
    "SpaMask": "/data_hou/ST_data_new/model-zn/spamask/results/multiple_adata_xe_breast_spamask.h5ad",
    "SpaCross": "/data_hou/ST_data_new/model-zn/spacross/results/multiple_adata_xe_breast_spacross.h5ad",
    "SpaBatch": "/data_hou/ST_data_new/model-zn/spabatch/results/multiple_adata_xe_breast_spabatch.h5ad"
}
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="Benchmark xe_breast only")
    ...
    if results:
        ...
        df[["Method", "Sample"] + ALL_METRICS].to_csv("/data_hou/ST_data_new/model-zn/comparison/results/individual_models/xe_all_metrics0711.csv", index=False)
        print("\nResults saved to /data_hou/ST_data_new/model-zn/comparison/results/individual_models/xe_all_metrics0711.csv")
