...
DATA_PATHS = {
    "RAW": "/data_hou/ST_data_new/model-zn/data_raw/hd_crc_raw_adata1.h5ad",
    "DeepST": "/data_hou/ST_data_new/model-zn/deepst/results/hd_crc_deepst_adata1.h5ad",
    "GraphST": "/data_hou/ST_data_new/model-zn/graphst/results/hd_crc_graphst_adata1.h5ad",
    "STAligner": "/data_hou/ST_data_new/model-zn/STAligner/results/hd_crc_sta_adata1.h5ad",
    "Spatialign": "/data_hou/ST_data_new/model-zn/spatialign/results/hd_crc/hd_crc_spa_adata1.h5ad",
    "SPIRAL": "/data_hou/ZhaoMH/new_model/Spiral/results/hd_crc_spiral_adata1.h5ad",
    "STitch3D": "/data_hou/ST_data_new/model-zn/STitch3D/results/hd_crc/hd_crc_stitch3d_adata1.h5ad",
    "PRECAST": "/data_hou/ST_data_new/model-zn/precast/results/hd_crc_seuInt_with_all_spatial.h5ad",
    "SpaMask": "/data_hou/ST_data_new/model-zn/spamask/results/multiple_adata_hd_crc_spamask.h5ad",
    "SpaCross": "/data_hou/ST_data_new/model-zn/spacross/results/multiple_adata_hd_crc_spacross.h5ad",
    "SpaBatch": "/data_hou/ST_data_new/model-zn/spabatch/results/multiple_adata_hd_crc_spabatch.h5ad"
}
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="Benchmark hd_crc only")
    ...
    if results:
        ...
        df[["Method", "Sample"] + ALL_METRICS].to_csv("/data_hou/ST_data_new/model-zn/comparison/results/individual_models/hd_all_metrics0711.csv", index=False)
        print("\nResults saved to /data_hou/ST_data_new/model-zn/comparison/results/individual_models/hd_all_metrics.csv")
