...
DATA_PATHS = {
    "RAW": "/data_hou/ST_data_new/model-zn/data_raw/spatch_ov_raw_adata1.h5ad",
    "DeepST": "/data_hou/ST_data_new/model-zn/deepst/results/spatch_ov_deepst_adata1.h5ad",
    "GraphST": "/data_hou/ST_data_new/model-zn/graphst/results1/spatch_ov_graphst_adata1.h5ad",
    "STAligner": "/data_hou/ST_data_new/model-zn/STAligner/results/spatch_ov_sta_adata1.h5ad",
    "Spatialign": "/data_hou/ST_data_new/model-zn/spatialign/results/spatch_ov/spatch_ov_spa_multiple_adata1.h5ad",
    "SPIRAL": "/data_hou/ZhaoMH/new_model/Spiral/results/spatch_ov_spiral_adata1.h5ad",
    "STitch3D": "/data_hou/ST_data_new/model-zn/STitch3D/results/spatch_ov/spatch_ov_stitch3d_adata1.h5ad",
    "PRECAST": "/data_hou/ST_data_new/model-zn/precast/results/spatch_ov_seuInt_with_all_spatial.h5ad",
    "SpaMask":  "/data_hou/ST_data_new/model-zn/spamask/results/multiple_adata_spatch_ov_spamask.h5ad",
    "SpaCross": "/data_hou/ST_data_new/model-zn/spacross/results/multiple_adata_spatch_ov_spacross.h5ad",
    "SpaBatch": "/data_hou/ZhaoMH/new_model/SpaBatch-main/Results/multiple_adata_spatch_ov_spabatch.h5ad"
}
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="Benchmark spatch_ov only")
    ...
    if results:
        ...
        df[["Method", "Sample"] + ALL_METRICS].to_csv("/data_hou/ST_data_new/model-zn/comparison/results/individual_models/spatch_ov_all_metrics0711.csv", index=False)
        print("\nResults saved to /data_hou/ST_data_new/model-zn/comparison/results/individual_models/spatch_ov_all_metrics0711.csv")
